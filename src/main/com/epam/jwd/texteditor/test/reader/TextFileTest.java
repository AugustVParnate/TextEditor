package main.com.epam.jwd.texteditor.test.reader;

import main.com.epam.jwd.texteditor.exception.FileReadException;
import main.com.epam.jwd.texteditor.reader.TextFile;
...
public class TextFileTest {
    ...
    private void assertNotNull(TextFile instance) {
    }
    ...
    private void assertEquals(String read, String text) {
    }
